  ...
  define(
    ...
    function (e, t, n) {
      ...
      (t.handler.attach = function (e) {
        (o = e.session.$selectLongWords),
          (e.session.$selectLongWords = !0),
          (u = e.session.$useEmacsStyleLineStart),
        ...
        (t.handler.detach = function (e) {
          (e.renderer.$blockCursor = !1),
            (e.session.$selectLongWords = o),
            (e.session.$useEmacsStyleLineStart = u),
            e.off("click", f),
            e.off("changeSession", a),
      ...
      var a = function (e) {
          e.oldSession &&
            ((e.oldSession.$selectLongWords = o),
            (e.oldSession.$useEmacsStyleLineStart = u)),
            (o = e.session.$selectLongWords),
            (e.session.$selectLongWords = !0),
            (u = e.session.$useEmacsStyleLineStart),
            (e.session.$useEmacsStyleLineStart = !0),
        ...
        l = e("../lib/keys").KEY_MODS,
        c = { C: "ctrl", S: "shift", M: "alt", CMD: "command" },
        h = [
          "C-S-M-CMD",
          "S-M-CMD",
          "C-M-CMD",
