          ...
          (this.getCompletions = function (e, t, n, r) {
            ...
            if (e === "ruleset" || t.$mode.$id == "ace/mode/scss") {
              var i = t.getLine(n.row).substr(0, n.column),
                s = /\([^)]*$/.test(i);
              return (
                s && (i = i.substr(i.lastIndexOf("(") + 1)),
                /:[^;]+$/.test(i)
                  ? (/([\w\-]+):[^:]*$/.test(i),
                    this.getPropertyValueCompletions(e, t, n, r))
                  : this.getPropertyCompletions(e, t, n, r, s)
              );
            }
            return [];
          }),
          (this.getPropertyCompletions = function (e, t, n, i, s) {
            s = s || !1;
            var o = Object.keys(r);
        ...
        o = function () {
          ...
          this.$rules.tag_stuff.unshift({
            ...
            next: [
              ...
              { token: "empty", regex: "", next: "tag_stuff" },
            ],
          }),
            (this.$rules["latte-content"] = [
              {
                ...
                regex: "\\/\\*",
                push: [
                  { token: "comment.end.latte", regex: "\\*\\/", next: "pop" },
                  { defaultToken: "comment" },
                ],
              },
              {
              ...
              { token: "constant.language", regex: "\\b(?:[A-Z0-9_]+)\\b" },
              { token: "string.unquoted", regex: "\\w+(?:-+\\w+)*" },
