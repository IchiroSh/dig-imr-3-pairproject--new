    ...
    (function (e, n, r) {
      ...
      function O(e) {
        var t = k.apply(null, x.call(arguments, 1)),
          ...
          r;
        throw (
          (e === null || typeof e.line == "undefined"
            ? ((r = P - R + 1),
              (n = A(new SyntaxError(k("[%1:%2] %3", q, r, t)))),
              (n.index = P),
              (n.line = q),
              (n.column = r))
            : ((r = e.range[0] - e.lineStart),
              (n = A(new SyntaxError(k("[%1:%2] %3", e.line, r, t)))),
              (n.line = e.line),
              (n.index = e.range[0]),
              (n.column = r)),
          n)
      ...
      function U() {
        W();
        while (45 === t.charCodeAt(P) && 45 === t.charCodeAt(P + 1)) rt(), W();
        if (P >= r)
          return {
            type: c,
            value: "<eof>",
      ...
      function V(e) {
        return (
          (P += e.length),
          { type: m, value: e, line: q, lineStart: R, range: [I, P] }
        );
      }
      function $() {
        return (
          (P += 3),
          { type: b, value: "...", line: q, lineStart: R, range: [I, P] }
        );
      }
      function J() {
        var e = t.charCodeAt(P++),
        ...
        for (;;) {
          ...
          if (P > r || ft(a))
            (u += t.slice(o, P - 1)),
              O(null, w.unfinishedString, t.slice(I, P - 1));
          if (92 === a) {
            if (!s.discardStrings) {
              var f = t.slice(o, P - 1);
              u += s.fixup(f);
        ...
        return (
          s.discardStrings ||
            ((u += s.encodeByte(null)), (u += s.fixup(t.slice(o, P - 1)))),
          {
            type: h,
            value: u,
            line: n,
      ...
      function Q() {
        ...
        return (
          ...
          { type: v, value: r.value, line: q, lineStart: R, range: [I, P] }
        );
      }
      function G() {
      ...
      function Z() {
        var e = 0,
          ...
          u;
        (u = P += 2),
          ct(t.charCodeAt(P)) || O(null, w.malformedNumber, t.slice(I, P));
        while (ct(t.charCodeAt(P))) ++P;
        ...
        if ("." === t.charAt(P)) {
          ...
          while (ct(t.charCodeAt(P))) ++P;
          (e = t.slice(s, P)),
            (e = s === P ? 0 : parseInt(e, 16) / Math.pow(16, P - s));
        }
        var f = !1;
        if ("pP".indexOf(t.charAt(P) || null) >= 0) {
          (f = !0),
            ++P,
            "+-".indexOf(t.charAt(P) || null) >= 0 &&
              (r = "+" === t.charAt(P++) ? 1 : -1),
            (o = P),
            lt(t.charCodeAt(P)) || O(null, w.malformedNumber, t.slice(I, P));
          while (lt(t.charCodeAt(P))) ++P;
      ...
      function tt() {
        var e = P++;
        t.charAt(P++) !== "{" &&
          O(null, w.braceExpected, "{", "\\" + t.slice(e, P)),
          ct(t.charCodeAt(P)) ||
            O(null, w.hexadecimalDigitExpected, "\\" + t.slice(e, P));
        while (t.charCodeAt(P) === 48) ++P;
        var n = P;
        ...
        var i = parseInt(t.slice(n, P - 1) || "0", 16),
          o = "\\" + t.slice(e, P);
        return (
          i > 1114111 && O(null, w.tooLargeCodepoint, o), s.encodeUTF8(i, o)
        );
      }
      function nt() {
        var e = P;
        switch (t.charAt(P)) {
          ...
          case "8":
          case "9":
            while (lt(t.charCodeAt(P)) && P - e < 3) ++P;
            var n = t.slice(e, P),
              r = parseInt(n, 10);
            return (
              r > 255 && O(null, w.decimalEscapeTooLarge, "\\" + r),
              s.encodeByte(r, "\\" + n)
            );
          case "z":
        ...
        return (
          i.strictEscapes && O(null, w.invalidEscape, "\\" + t.slice(e, P + 1)),
          t.charAt(P++)
        );
      }
      function rt() {
        ...
        if (n.comments) {
          ...
          n.locations &&
            (f.loc = {
              start: { line: a, column: I - u },
              end: { line: q, column: P - R },
            }),
            n.ranges && (f.range = [I, P]),
            n.onCreateNode && n.onCreateNode(f),
            F.push(f);
        }
      }
      function it(e) {
        var n = 0,
          ...
          a = q;
        ++P;
        while ("=" === t.charAt(P + n)) ++n;
        if ("[" !== t.charAt(P + n)) return !1;
        (P += n + 1), ft(t.charCodeAt(P)) && z(), (u = P);
        while (P < r) {
          while (ft(t.charCodeAt(P))) z();
          o = t.charAt(P++);
          if ("]" === o) {
            s = !0;
            for (var f = 0; f < n; ++f) "=" !== t.charAt(P + f) && (s = !1);
            "]" !== t.charAt(P + n) && (s = !1);
          }
        ...
        O(
          null,
          e ? w.unfinishedLongComment : w.unfinishedLongString,
          a,
          "<eof>"
        );
      }
      ...
      function Ft(e) {
        var t = H,
          r = Kt();
        return (
          n.scope && (St("::" + t.value + "::"), Tt(r, !0)),
          ut("::"),
          e.addLabel(t.value, t),
          S(E.labelStatement(r))
        );
      }
      function It() {
      ...
      function Ut(e) {
        ...
        var r = Bt(e);
        return (
          e.popScope(), n.scope && Et(), ut("end"), S(E.whileStatement(t, r))
        );
      }
      function zt(e) {
      ...
      function Xt(e) {
        ...
        while (ot("elseif"))
          Mt(s),
            ...
            e.popScope(),
            n.scope && Et(),
            t.push(S(E.elseifClause(r, i))),
            kt && (s = Lt());
        return (
          ot("else") &&
            (kt && ((s = new At(B)), Ct.push(s)),
            n.scope && wt(),
            e.pushScope(),
            (i = Bt(e)),
            e.popScope(),
            n.scope && Et(),
            t.push(S(E.elseClause(i)))),
          ut("end"),
          S(E.ifStatement(t))
        );
      }
      function Vt(e) {
        ...
        if (ot("=")) {
          ...
          return (
            ...
            ut("end"),
            n.scope && Et(),
            S(E.forNumericStatement(t, i, s, o, r))
          );
        }
        var u = [t];
        while (ot(",")) (t = Kt()), n.scope && xt(t), u.push(t);
        ut("in");
        var a = [];
        do {
          var f = en(e);
      ...
      function $t(e) {
        ...
        if (d === H.type) {
          var i = [],
            s = [];
          do (t = Kt()), i.push(t), e.addLocal(t.name, r);
          while (ot(","));
          if (ot("="))
            do {
              var o = en(e);
          ...
          if (n.scope) for (var u = 0, a = i.length; u < a; ++u) xt(i[u]);
      ...
      function Jt(e) {
        ...
        if (a.length === 1 && s === null)
          return Mt(r), S(E.callStatement(a[0]));
        if (!s) return D(H);
        ut("=");
        var l = [];
        do l.push(en(e));
        ...
        for (;;) {
          ...
          if (m === H.type && ot("["))
            (n = en(e)),
              ...
              ut("="),
              (r = en(e)),
              t.push(S(E.tableKey(n, r)));
          else if (d === H.type)
            "=" === j.value
              ? ((n = Kt()),
                st(),
                (r = en(e)),
                t.push(S(E.tableKeyString(n, r))))
              : ((r = en(e)), t.push(S(E.tableValue(r))));
          else {
            if (null == (r = Zt(e))) {
              Ct.pop();
              break;
      ...
      function nn(e, t) {
        ...
        for (;;) {
          ...
          ("^" === n || ".." === n) && --o, st();
          var u = nn(o, t);
          null == u && _("<expression>", H),
            kt && Ct.push(i),
            (r = S(E.binaryExpression(n, r, u)));
        }
        return r;
      }
      function rn(e, t, n) {
        ...
        if (m === H.type)
          switch (H.value) {
            case "[":
              return (
                Mt(t), st(), (r = en(n)), ut("]"), S(E.indexExpression(e, r))
              );
            case ".":
      ...
      function sn(e) {
        var t, r, i;
        kt && (i = Lt());
        if (d === H.type) (r = H.value), (t = Kt()), n.scope && Tt(t, Nt(r));
        else {
          if (!ot("(")) return null;
          (t = en(e)), ut(")");
        }
      ...
      function on(e, t) {
        if (m === H.type)
          switch (H.value) {
            case "(":
              i.emptyStatement ||
                (H.line !== B.line && O(null, w.ambiguousSyntax, H.value)),
                st();
              var n = [],
                r = Zt(t);
              null != r && n.push(r);
              while (ot(",")) (r = en(t)), n.push(r);
      ...
      function un(e) {
        var r = h | v | g | y | b,
          ...
          o;
        kt && (o = Lt()),
          s === b && !e.allowVararg && O(H, w.cannotUseVararg, H.value);
        if (s & r) {
          Mt(o);
        ...
        if (p === s && "function" === i)
          return Mt(o), st(), n.scope && wt(), Qt(null);
      ...
      function fn(u, a) {
        "undefined" == typeof a &&
          ...
          (bt = []),
          (Ct = []);
        if (!Object.prototype.hasOwnProperty.call(an, n.luaVersion))
          throw new Error(k("Lua version '%1' not supported", n.luaVersion));
        (i = L({}, an[n.luaVersion])),
          n.extendedIdentifiers !== void 0 &&
            (i.extendedIdentifiers = !!n.extendedIdentifiers);
        if (!Object.prototype.hasOwnProperty.call(l, n.encodingMode))
          throw new Error(
            k("Encoding mode '%1' not supported", n.encodingMode)
          );
        return (
          (s = l[n.encodingMode]), n.comments && (F = []), n.wait ? e : cn()
        );
      }
      function ln(n) {
      ...
      (At.prototype.complete = function () {
        n.locations &&
          ((this.loc.end.line = B.lastLine || B.line),
          (this.loc.end.column =
            B.range[1] - (B.lastLineStart || B.lineStart))),
          n.ranges && (this.range[1] = B.range[1]);
      }),
        ...
        (_t.prototype.isInLoop = function () {
          ...
          while (e-- > 0) if (this.scopes[e].isLoop) return !0;
          return !1;
        }),
        ...
        (_t.prototype.popScope = function () {
          for (var e = 0; e < this.pendingGotos.length; ++e) {
            ...
            t.maxDepth >= this.scopes.length &&
              --t.maxDepth <= 0 &&
              O(t.token, w.labelNotVisible, t.target);
          }
          this.scopes.pop();
        }),
          ...
          if (Object.prototype.hasOwnProperty.call(n.labels, e))
            ...
            for (var i = 0; i < this.pendingGotos.length; ++i) {
              ...
              if (s.maxDepth >= this.scopes.length && s.target === e) {
                s.localCounts[this.scopes.length - 1] < n.locals.length &&
                  n.deferredGotos.push(s);
                continue;
              }
              r.push(s);
            }
        ...
        (Dt.prototype.addGoto = Dt.prototype.addLabel =
          function () {
            throw new Error("This should never happen");
          }),
        (Dt.prototype.addLocal = Dt.prototype.raiseDeferredErrors =
          function () {}),
        (e.parse = fn);
      var an = {
        5.1: {},
