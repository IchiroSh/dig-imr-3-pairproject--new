  ...
  define(
    ...
    function (e, t, n) {
      ...
      function E(e, t) {
        ...
        return t.from() == t.anchor &&
          !t.empty() &&
          t.head.line == r.line &&
          t.head.ch != r.ch
          ? new w(t.head.line, t.head.ch - 1)
          : t.head;
      }
      function S(e, t, n) {
      ...
      function C(e) {
        e.setOption("disableInput", !0),
          ...
          e.on("cursorActivity", ar),
          ut(e),
          m.on(e.getInputField(), "paste", P(e));
      }
      function k(e) {
        e.setOption("disableInput", !1),
          e.off("cursorActivity", ar),
          m.off(e.getInputField(), "paste", P(e)),
          (e.state.vim = null),
          Rn && clearTimeout(Rn);
      }
      function L(e, t) {
      ...
      function D(e) {
        ...
        return r
          ? (Q(n) && (t[t.length - 1] = n.toLowerCase()),
            "<" + t.join("-") + ">")
          : !1;
      }
      function P(e) {
        ...
        return (
          t.onPasteFn ||
            (t.onPasteFn = function () {
              t.insertMode ||
                (e.setCursor(Lt(e.getCursor(), 0, 1)),
                Tt.enterInsertMode(e, {}, t));
            }),
          t.onPasteFn
        );
      }
      ...
      function tt(e, t, n, r, i) {
        ...
        n || (n = "string"),
          (et[e] = { type: n, defaultValue: t, callback: i });
        if (r) for (var s = 0; s < r.length; s++) et[r[s]] = et[e];
        t && nt(e, t);
      }
      function nt(e, t, n, r) {
        var i = et[e];
      ...
      function Ct(e, t, n) {
        var r = e.state.vim,
          i = r.insertMode || r.visualMode,
          s = Math.min(Math.max(e.firstLine(), t.line), e.lastLine()),
          o = e.getLine(s),
          u = o.length - 1 + !!i,
          a = Math.min(Math.max(0, t.ch), u),
          f = o.charCodeAt(a);
        if (56320 < f && f < 57343) {
          var l = 1;
          n && n.line == s && n.ch > a && (l = -1), (a += l), a > u && (a -= 2);
        }
        return new w(s, a);
      }
      function kt(e) {
      ...
      function Bt(e, t) {
        return (
          arguments.length > 2 &&
            (t = Bt.apply(undefined, Array.prototype.slice.call(arguments, 1))),
          Ht(e, t) ? e : t
        );
      }
      function jt(e, t) {
        return (
          arguments.length > 2 &&
            (t = jt.apply(undefined, Array.prototype.slice.call(arguments, 1))),
          Ht(e, t) ? t : e
        );
      }
      function Ft(e, t, n) {
          ...
          i = function () {
            ...
            if (i) {
              ...
              (r = { line: r.line + d, ch: d ? r.ch : v + r.ch }),
                n.visualLine &&
                  ((t = new w(t.line, 0)), (r = new w(r.line, It(e, r.line)))),
                e.setSelection(t, r);
            }
            return [t, r];
          };
        ...
        return (
          ...
          Ht(i, s)
            ...
            : ((s = Bt(t, s)),
              ...
              i.ch == -1 &&
                i.line != e.firstLine() &&
                (i = new w(i.line - 1, It(e, i.line - 1)))),
          [s, i]
        );
      }
      function Kt(e, t, n) {
      ...
      function Gt(e) {
        ...
        return (
          e.getSelection().length == 1 && (t = Bt(t, e.getCursor("anchor"))), t
        );
      }
      function Yt(e, t) {
        var n = e.state.vim;
        t !== !1 && e.setCursor(Ct(e, n.sel.head)),
          $t(e, n),
          (n.visualMode = !1),
          (n.visualLine = !1),
          (n.visualBlock = !1),
      ...
      function on(e, t) {
        (at.lastCharacterSearch.increment = e),
          (at.lastCharacterSearch.forward = t.forward),
          (at.lastCharacterSearch.selectedCharacter = t.selectedCharacter);
      }
      function fn(e, t, n, r) {
      ...
      function yn(e, t, n, r, i) {
        ...
        function o(e, t, n, r) {
          var o = e.getLine(t),
            u = { line: o, ln: t, pos: n, dir: r };
          if (u.line === "") return { ln: u.ln, pos: u.pos };
          var a = u.pos;
          s(u);
          while (u.line !== null) {
            a = u.pos;
            if (Y(u.line[u.pos])) {
              if (!i) return { ln: u.ln, pos: u.pos + 1 };
              s(u);
              while (u.line !== null) {
                if (!G(u.line[u.pos])) break;
                (a = u.pos), s(u);
              }
              return { ln: u.ln, pos: a + 1 };
            }
            s(u);
          }
          return { ln: u.ln, pos: a + 1 };
        ...
        function u(e, t, n, r) {
          ...
          s(u);
          while (u.line !== null) {
            if (!G(u.line[u.pos]) && !Y(u.line[u.pos])) a = u.pos;
            else if (Y(u.line[u.pos]))
              return i
                ? G(u.line[u.pos + 1])
                  ? { ln: u.ln, pos: u.pos + 1 }
                  : { ln: u.ln, pos: a }
        ...
        while (n > 0)
          r < 0 ? (a = u(e, a.ln, a.pos, r)) : (a = o(e, a.ln, a.pos, r)), n--;
        return new w(a.ln, a.pos);
      }
      function bn(e, t, n, r) {
        function i(e, t) {
        ...
        function s(e, t, n, r) {
          ...
          while (u.line !== null) {
            ...
            Y(u.line[u.pos]) &&
              !o &&
              (u.pos === u.line.length - 1 || G(u.line[u.pos + 1])) &&
              (o = !0),
              i(e, u);
          }
      ...
      function En(e, t, n, r) {
        ...
        return !u || !a
          ? { start: i, end: i }
          : (r && (--u, ++a),
            { start: new w(i.line, u), end: new w(i.line, a) });
      }
      function Sn() {}
      function xn(e) {
        var t = e.state.vim;
        return t.searchState_ || (t.searchState_ = new Sn());
      }
      function Tn(e) {
        return Cn(e, "/");
      }
      ...
      function Bn(e, t) {
        return Pn(
          ...
          t && Pn("span", { $color: "#888" }, t)
        );
      }
      function jn(e, t) {
        var n = Bn(t.prefix, t.desc);
        if (e.openDialog)
      ...
      function In(e, t, n, r) {
        ...
        var i = xn(e),
          s = Dn(t, !!n, !!r);
        if (!s) return;
        return Un(e, s), Fn(s, i.getQuery()) ? s : (i.setQuery(s), s);
      }
      function qn(e) {
              ...
              if (o == 0 && u && Pt(s.from(), i)) {
                ...
                (u = s.find(t)),
                  u &&
                    !u[0] &&
                    Pt(s.from(), a) &&
                    e.getLine(a.line).length == a.ch &&
                    (u = s.find(t));
              }
              if (!u) {
                s = e.getSearchCursor(
                  n,
                  t ? new w(e.lastLine()) : new w(e.firstLine(), 0)
                );
                if (!s.find(t)) return;
              }
            }
      ...
      function Xn(e) {
        var t = xn(e);
        e.removeOverlay(xn(e).getOverlay()),
          t.setOverlay(null),
      ...
      function Zn(e, t, n, r, i, s, o, u, a) {
        ...
        jn(e, {
          prefix: Pn("span", "replace with ", Pn("strong", u), " (y/n/a/q/l)"),
          onKeyDown: b,
        });
      }
      function er(e) {
        ...
        i || (e.off("change", ur), m.off(e.getInputField(), "keydown", cr)),
          !i &&
            t.insertModeRepeat > 1 &&
            (hr(e, t, t.insertModeRepeat - 1, !0),
      ...
      function rr(e, t, n, r) {
        ...
        if (r == ":") {
          i.keyBuffer[0] && Yn.processCommand(e, i.keyBuffer[0]),
            (n.isPlaying = !1);
          return;
        }
        var s = i.keyBuffer,
        ...
        for (var u = 0; u < s.length; u++) {
          ...
          while (a) {
            (f = /<\w+-.+?>|<\w+>|./.exec(a)),
              ...
              ct.handleKey(e, l, "macro");
            if (t.insertMode) {
              var c = i.insertModeChanges[o++].changes;
              (at.macroModeState.lastInsertModeChanges.changes = c),
                pr(e, c, 1),
                er(e);
            }
          }
      ...
      function cr(e) {
        ...
        (r.indexOf("Delete") != -1 || r.indexOf("Backspace") != -1) &&
          m.lookupKey(r, "vim-insert", i);
      }
      function hr(e, t, n, r) {
        function u() {
          s
            ? yt.processAction(e, t, t.lastEditActionCommand)
            : yt.evalInput(e, t);
        }
        function a(n) {
        ...
        (t.inputState = o), t.insertMode && !r && er(e), (i.isPlaying = !1);
      }
      function pr(e, t, n) {
        function r(t) {
        ...
        for (var o = 0; o < n; o++) {
          ...
          for (var u = 0; u < t.length; u++) {
            var a = t[u];
            if (a instanceof lr) m.lookupKey(a.keyName, "vim-insert", r);
            else if (typeof a == "string") e.replaceSelection(a);
            else {
              var f = e.getCursor(),
                l = Lt(f, 0, a[0].length);
          ...
          e.operation(function () {
            e.ace.forEachSelection(function () {
              ...
              (s = Lt(s, 0, a)),
                ...
                e.virtualSelectionMode() && (e.state.vim = gr(u));
            }),
      ...
      (m.Pos = function (e, t) {
        ...
        (m.e_stop = m.e_preventDefault = f.stopEvent),
        ...
        (m.lookupKey = function Er(e, t, n) {
          ...
          if (t.fallthrough) {
            if (!Array.isArray(t.fallthrough)) return Er(e, t.fallthrough, n);
            for (var i = 0; i < t.fallthrough.length; i++) {
              var s = Er(e, t.fallthrough[i], n);
              if (s) return s;
            }
          }
        }),
        ...
        function () {
            ...
            (this.listSelections = function (e) {
              ...
              return !t.length || this.ace.inVirtualSelectionMode
                ...
                : t.map(function (e) {
                    return {
                      anchor: this.clipPos(
                        y(e.cursor == e.end ? e.start : e.end)
                      ),
            ...
            (this.setSelections = function (e, t) {
              var n = this.ace.multiSelect,
                r = e.map(function (e) {
                  ...
                  return (
                    (r.cursor = i.comparePoints(r.start, n) ? r.end : r.start),
                    r
                  );
                });
          ...
          (e.prototype.clear = function () {
            ...
            (this.replaceRange = function (e, t, n) {
              ...
              return (
                this.ace.session.$clipRangeToDocument(r),
                this.ace.session.replace(r, e)
              );
            }),
          ...
          (this.setOption = function (e, n) {
            ...
            (this.findMatchingTag = function (e) {
              ...
              if (!t) return;
              return {
                open: { from: y(t.openTag.start), to: y(t.openTag.end) },
                close: { from: y(t.closeTag.start), to: y(t.closeTag.end) },
              };
            }),
          ...
          m.defineExtension("openDialog", function (n, r, i) {
            function a(e) {
              if (typeof e == "string") f.value = e;
                ...
                if (e && e.type == "blur" && document.activeElement === f)
                  return;
                u.state.dialog == s && ((u.state.dialog = null), u.focus()),
                  (o = !0),
                  s.remove(),
            ...
            if (f)
              i.value &&
                ...
                i.onInput &&
                  m.on(f, "input", function (e) {
                    i.onInput(e, f.value, a);
                  }),
                i.onKeyUp &&
                  m.on(f, "keyup", function (e) {
      ...
      var M = {
        ...
        _ = { Enter: "CR", Backspace: "BS", Delete: "Del", Insert: "Ins" },
        H = /[\d]/,
        B = [
          m.isWordChar,
          function (e) {
      ...
      var at,
        ...
        ct = {
          ...
          defineEx: function (e, t, n) {
            ...
            (Gn[e] = n),
              (Yn.commandMap_[t] = { name: e, shortName: t, type: "api" });
          },
          handleKey: function (e, t, n) {
            var r = this.findKey(e, t, n);
            if (typeof r == "function") return r();
          },
          multiSelectHandleKey: yr,
          findKey: function (e, t, n) {
            ...
            function s() {
              if (t == "<Esc>") {
                if (r.visualMode) Yt(e);
                else {
                  if (!r.insertMode) return;
                  er(e);
                }
                return pt(e), !0;
              }
            ...
            function a() {
              ...
              var u = r.visualMode ? "visual" : "normal",
                a = o[2] || o[1];
              r.inputState.operatorShortcut &&
                r.inputState.operatorShortcut.slice(-1) == a &&
                (a = r.inputState.operatorShortcut);
              var f = yt.matchCommand(a, x, r.inputState, u);
              return f.type == "none"
                ? (pt(e), !1)
                : f.type == "partial"
                ? !0
        ...
        (mt.prototype = {
          pushText: function (e, t, n, r, i) {
            ...
            if (!s) {
              switch (t) {
                ...
                case "change":
                  n.indexOf("\n") == -1
                    ? (this.registers["-"] = new dt(n, r))
                    : (this.shiftNumericRegisters_(),
                      (this.registers[1] = new dt(n, r)));
              }
          ...
          getRegister: function (e) {
            return this.isValidRegister(e)
              ? ((e = e.toLowerCase()),
                this.registers[e] || (this.registers[e] = new dt()),
                this.registers[e])
      ...
      var yt = {
          matchCommand: function (e, t, n, r) {
            ...
            if (s.keys.slice(-11) == "<character>") {
              var a = Mt(e);
              if (!a || a.length > 1) return { type: "clear" };
          ...
          processMotion: function (e, t, n) {
            (t.inputState.motion = n.motion),
              (t.inputState.motionArgs = kt(n.motionArgs)),
              this.evalInput(e, t);
          },
          processOperator: function (e, t, n) {
            ...
            (r.operator = n.operator),
              (r.operatorArgs = kt(n.operatorArgs)),
              n.keys.length > 1 && (r.operatorShortcut = n.keys),
              n.exitVisualBlock && ((t.visualBlock = !1), Kt(e)),
          ...
          processSearch: function (e, t, n) {
            function a(r, i, s) {
              at.searchHistoryController.pushInput(r),
                at.searchHistoryController.reset();
              try {
                In(e, r, i, s);
              } catch (o) {
                Hn(e, "Invalid regex: " + r), pt(e);
                return;
              }
            ...
            function l(t, n, i) {
              ...
              s == "Up" || s == "Down"
                ? ((o = s == "Up" ? !0 : !1),
                  ...
                  (n = at.searchHistoryController.nextMatch(n, o) || ""),
                  i(n),
                  a &&
                    t.target &&
              ...
              f
                ? e.scrollIntoView(zn(e, !r, f), 30)
                : (Xn(e), e.scrollTo(u.left, u.top));
            }
            function c(t, n, r) {
              var i = m.keyName(t);
              i == "Esc" ||
              ...
              i == "Ctrl-[" ||
              (i == "Backspace" && n == "")
                ? (at.searchHistoryController.pushInput(n),
                  at.searchHistoryController.reset(),
                  In(e, o),
                  Xn(e),
            ...
            switch (n.searchArgs.querySrc) {
              ...
              case "wordUnderCursor":
                ...
                v && i ? (p = "\\b" + p + "\\b") : (p = Rt(p)),
                  (at.jumpList.cachedCursor = e.getCursor()),
                  e.setCursor(d.start),
                  a(p, !0, !1);
            }
          },
          processEx: function (e, t, n) {
            function r(t) {
              at.exCommandHistoryController.pushInput(t),
            ...
            function i(t, n, r) {
              ...
              if (
                ...
                at.exCommandHistoryController.pushInput(n),
                  at.exCommandHistoryController.reset(),
                  m.e_stop(t),
                  pt(e),
                  r(),
              ...
              i == "Up" || i == "Down"
                ? (m.e_stop(t),
                  ...
                  (n = at.exCommandHistoryController.nextMatch(n, s) || ""),
                  r(n),
                  o &&
                    t.target &&
                    (t.target.selectionEnd = t.target.selectionStart =
          ...
          evalInput: function (e, t) {
            ...
            if (r) {
              ...
              m instanceof Array ? ((d = m[0]), (p = m[1])) : (p = m),
                p || (p = Dt(f));
              if (t.visualMode) {
                if (!t.visualBlock || p.ch !== Infinity) p = Ct(e, p, c);
                d && (d = Ct(e, d)),
                  (d = d || h),
                  (a.anchor = d),
                  (a.head = p),
                  ...
                  vn(e, t, "<", Ht(d, p) ? d : p),
                  vn(e, t, ">", Ht(d, p) ? p : d);
              } else s || ((p = Ct(e, p, c)), e.setCursor(p.line, p.ch));
            }
            if (s) {
              if (o.lastSel) {
                d = h;
                var b = o.lastSel,
                  ...
                  x = Math.abs(b.head.ch - b.anchor.ch);
                b.visualLine
              ...
              var T, N, C, k, L;
              if (t.visualMode) {
                (T = Bt(a.head, a.anchor)),
                  (N = jt(a.head, a.anchor)),
                  (C = t.visualLine || o.linewise),
                  (k = t.visualBlock ? "block" : C ? "line" : "char");
                var A = S(e, T, N);
                L = Qt(e, { anchor: A.start, head: A.end }, k);
                if (C) {
                  var O = L.ranges;
                  if (k == "block")
                    for (var M = 0; M < O.length; M++)
                      O[M].head.ch = It(e, O[M].head.line);
                  else
                    k == "line" && (O[0].head = new w(O[0].head.line + 1, 0));
                }
              } else {
                (T = Dt(d || h)), (N = Dt(p || c));
                if (Ht(N, T)) {
                ...
                (C = i.linewise || o.linewise),
                  C ? en(e, T, N) : i.forward && Zt(e, T, N),
                  (k = "char");
                var D = !i.inclusive || C,
                  A = S(e, T, N);
                L = Qt(e, { anchor: A.start, head: A.end }, k, D);
              }
              e.setSelections(L.ranges, L.primary),
                ...
                (o.registerName = u),
                (o.linewise = C);
              var P = St[s](e, o, L.ranges, h, p);
              t.visualMode && Yt(e, P != null), P && e.setCursor(P);
            }
          },
        ...
        bt = {
          ...
          findNext: function (e, t, n) {
            ...
            var s = !n.forward;
            return (
              (s = r.isReversed() ? !s : s), Un(e, i), zn(e, s, i, n.repeat)
            );
          },
          findAndSelectNextInclusive: function (e, t, n, r, i) {
            var s = xn(e),
              o = s.getQuery();
            if (!o) return;
            var u = !n.forward;
            u = s.isReversed() ? !u : u;
            var a = Wn(e, u, o, n.repeat, r);
            if (!a) return;
            ...
            if (r.visualMode) {
              ...
              (r.visualMode = !0),
                (r.visualLine = !1),
                (r.visualBlock = !1),
                m.signal(e, "vim-mode-change", { mode: "visual", subMode: "" });
            return u ? [l, f] : [f, l];
          },
          goToMark: function (e, t, n, r) {
            var i = Jn(e, r, n.selectedCharacter);
            return i
              ? n.linewise
                ? { line: i.line, ch: tn(e.getLine(i.line)) }
                : i
              : null;
          },
          moveToOtherHighlightedEnd: function (e, t, n, r) {
            if (r.visualBlock && n.sameLine) {
              var i = r.sel;
              return [
                Ct(e, new w(i.anchor.line, i.head.ch)),
                Ct(e, new w(i.head.line, i.anchor.ch)),
              ];
            }
            ...
            return (
              l &&
                (n.forward
                  ...
                  : (u = l.start.row)),
              n.toFirstChar && ((s = tn(e.getLine(u))), (r.lastHPos = s)),
              (r.lastHSPos = e.charCoords(new w(u, s), "div").left),
              new w(u, s)
            );
          },
          ...
          moveByScroll: function (e, t, n, r) {
            ...
            (n.repeat = o), (s = bt.moveByDisplayLines(e, t, n, r));
            if (!s) return null;
          ...
          moveToMatchedSymbol: function (e, t) {
            ...
            if (i < s.length) {
              var a = /[<>]/.test(s[i]) ? /[(){}[\]<>]/ : /[(){}[\]]/,
                f = e.findMatchingBracket(new w(r, i + 1), { bracketRegex: a });
              return f.to;
            }
            return n;
          },
          ...
          textObjectManipulation: function (e, t, n, r) {
            ...
            var u = !n.textObjectInner,
              a;
            if (i[o]) a = wn(e, t, o, u);
            else if (s[o]) a = En(e, t, o, u);
            else if (o === "W") a = nn(e, u, !0, !0);
            else if (o === "w") a = nn(e, u, !0, !1);
            else if (o === "p") {
            ...
            } else if (o === "t") a = rn(e, t, u);
            else {
              if (o !== "s") return null;
              var l = e.getLine(t.line);
              t.ch > 0 && Y(l[t.ch]) && (t.ch -= 1);
              var c = yn(e, t, n.repeat, 1, u),
                h = yn(e, t, n.repeat, -1, u);
              G(e.getLine(h.line)[h.ch]) &&
                G(e.getLine(c.line)[c.ch - 1]) &&
                (h = { line: h.line, ch: h.ch + 1 }),
                (a = { start: h, end: c });
            }
        ...
        St = {
          change: function (e, t, n) {
            ...
            if (!s.visualMode) {
              ...
              u.line > e.lastLine() && t.linewise && !c
                ...
                : e.replaceRange("", o, u),
                t.linewise &&
                  (c || (e.setCursor(l), m.commands.newlineAndIndent(e)),
            ...
            at.registerController.pushText(
              t.registerName,
              "change",
              i,
              t.linewise,
              ...
              Tt.enterInsertMode(e, { head: r }, e.state.vim);
          },
          delete: function (e, t, n) {
            ...
            if (!s.visualBlock) {
              ...
              t.linewise &&
                ...
                (o.line == e.firstLine()
                  ? (o.ch = 0)
                  : (o = new w(o.line - 1, It(e, o.line - 1)))),
                (i = e.getRange(o, u)),
                e.replaceRange("", o, u),
                (r = o),
                t.linewise && (r = bt.moveToFirstNonWhiteSpaceCharacter(e, o));
            } else {
              i = e.getSelection();
              var a = Et("", n.length);
          ...
          indent: function (e, t, n) {
            var r = e.state.vim;
            if (e.indentMore) {
              var i = r.visualMode ? t.repeat : 1;
              for (var s = 0; s < i; s++)
                t.indentRight ? e.indentMore() : e.indentLess();
            } else {
              var o = n[0].anchor.line,
                u = r.visualBlock
                  ? n[n.length - 1].anchor.line
                  : n[0].head.line,
                i = r.visualMode ? t.repeat : 1;
              t.linewise && u--;
              for (var a = o; a <= u; a++)
                for (var s = 0; s < i; s++) e.indentLine(a, t.indentRight);
            }
          ...
          indentAuto: function (e, t, n) {
            return (
              ...
              bt.moveToFirstNonWhiteSpaceCharacter(e, n[0].anchor)
            );
          },
          ...
          yank: function (e, t, n, r) {
            var i = e.state.vim,
              s = e.getSelection(),
              o = i.visualMode
                ? Bt(i.sel.anchor, i.sel.head, n[0].head, n[0].anchor)
                : r;
            return (
              at.registerController.pushText(
                t.registerName,
        ...
        Tt = {
          ...
          scrollToCursor: function (e, t) {
            ...
            switch (t.position) {
              case "center":
                ...
                break;
              case "bottom":
                var o = new w(n, e.getLine(n).length - 1),
                  u = e.charCoords(o, "local"),
                  a = u.bottom - s;
                s = s - i + a;
            }
            e.scrollTo(null, s);
          ...
          enterMacroRecordMode: function (e, t) {
            ...
            at.registerController.isValidRegister(r) &&
          ...
          enterInsertMode: function (e, t, n) {
            ...
            if (r == "eol") s = new w(s.line, It(e, s.line));
            else if (r == "bol") s = new w(s.line, 0);
            else if (r == "charAfter") {
              var u = S(e, s, Lt(s, 0, 1));
              s = u.end;
            } else if (r == "firstNonBlank") {
              var u = S(e, s, bt.moveToFirstNonWhiteSpaceCharacter(e, s));
              s = u.end;
            ...
            e.setOption("disableInput", !1),
              t && t.replace
                ...
                : (e.toggleOverwrite(!1),
                  e.setOption("keyMap", "vim-insert"),
                  m.signal(e, "vim-mode-change", { mode: "insert" })),
              at.macroModeState.isPlaying ||
                (e.on("change", ur), m.on(e.getInputField(), "keydown", cr)),
              n.visualMode && Yt(e),
              Wt(e, s, o);
          },
          toggleVisualMode: function (e, t, n) {
            ...
            if (!n.visualMode) {
              (n.visualMode = !0),
                ...
                (s = Ct(e, new w(i.line, i.ch + r - 1)));
              var o = S(e, i, s);
              (n.sel = { anchor: o.start, head: o.end }),
                m.signal(e, "vim-mode-change", {
                  mode: "visual",
          ...
          joinLines: function (e, t, n) {
            ...
            for (var a = r.line; a < i.line; a++) {
              ...
              var f = "",
                l = 0;
              if (!t.keepSpaces) {
                var c = e.getLine(r.line + 1);
                (l = c.search(/\S/)), l == -1 ? (l = c.length) : (f = " ");
              }
              e.replaceRange(f, new w(r.line, u), new w(r.line + 1, l));
            }
            var h = Ct(e, new w(r.line, u));
            n.visualMode && Yt(e, !1), e.setCursor(h);
          },
          ...
          paste: function (e, t, n) {
            ...
            if (t.registerName === "+")
              navigator.clipboard.readText().then(function (s) {
                r.continuePaste(e, t, n, s, i);
              });
            else {
              var s = i.toString();
              this.continuePaste(e, t, n, s, i);
            }
          },
          continuePaste: function (e, t, n, r, i) {
            var s = Dt(e.getCursor());
            if (!r) return;
            if (t.matchIndent) {
            ...
            if (t.repeat > 1) var r = Array(t.repeat + 1).join(r);
            var p = i.linewise,
              d = i.blockwise;
            if (d) {
              (r = r.split("\n")), p && r.pop();
              for (var v = 0; v < r.length; v++) r[v] = r[v] == "" ? " " : r[v];
              (s.ch += t.after ? 1 : 0), (s.ch = Math.min(It(e, s.line), s.ch));
            } else
              p
                ? n.visualMode
                  ? (r = n.visualLine
            ...
            if (n.visualMode) {
              ...
              n.lastSelection && (y = n.lastSelection.headMark.find()),
                at.registerController.unnamedRegister.setText(x),
                d
                  ? (e.replaceSelections(N),
                    (S = new w(E.line + r.length - 1, E.ch)),
                    e.setCursor(E),
                    zt(e, S),
              ...
              e.setCursor(s),
                zt(e, new w(s.line + r.length - 1, s.ch)),
                e.replaceSelections(r),
                (m = s);
            } else
              e.replaceRange(r, s),
          ...
          undo: function (e, t) {
            e.operation(function () {
              _t(e, m.commands.undo, t.repeat)(),
                e.setCursor(Ct(e, e.getCursor("start")));
            });
          },
          redo: function (e, t) {
          ...
          replace: function (e, t, n) {
            ...
            if (r == "\n")
              ...
              var l = e.getRange(i, o);
              (l = l.replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, r)),
                (l = l.replace(/[^\n]/g, r));
              if (n.visualBlock) {
                var c = new Array(e.getOption("tabSize") + 1).join(" ");
                (l = e.getSelection()),
                  (l = l.replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, r)),
                  (l = l.replace(/\t/g, c).replace(/[^\n]/g, r).split("\n")),
                  e.replaceSelections(l);
              } else e.replaceRange(l, i, o);
              n.visualMode
                ? ((i = Ht(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head),
                  e.setCursor(i),
                  Yt(e, !1))
                : e.setCursor(Lt(o, 0, -1));
            }
          },
          incrementNumberToken: function (e, t) {
            ...
            var v = new w(n.line, o),
              m = new w(n.line, u);
            e.replaceRange(a, v, m),
              e.setCursor(new w(n.line, o + a.length - 1));
          },
      ...
      Qn.prototype = {
        ...
        _processCommand: function (e, t, n) {
          ...
          if (!l) {
            Hn(e, 'Not an editor command ":' + t + '"');
            return;
          }
          try {
            Gn[l](e, u), (!f || !f.possiblyAsync) && u.callback && u.callback();
          } catch (a) {
            throw (Hn(e, a.toString()), a);
          }
        },
      ...
      var Gn = {
          ...
          map: function (e, t, n) {
            var r = t.args;
            if (!r || r.length < 2) {
              e && Hn(e, "Invalid mapping: " + t.input);
              return;
            }
            Yn.map(r[0], r[1], n);
          },
          ...
          unmap: function (e, t, n) {
            var r = t.args;
            (!r || r.length < 1 || !Yn.unmap(r[0], n)) &&
              e &&
              Hn(e, "No such mapping: " + t.input);
          },
          move: function (e, t) {
          ...
          sort: function (e, t) {
            ...
            function S(e, t) {
              ...
              var o = s && d.exec(e),
                u = s && d.exec(t);
              return o
                ? ((o = parseInt((o[1] + o[2]).toLowerCase(), v)),
          ...
          global: function (e, t) {
            var n = t.argString;
            if (!n) {
              Hn(e, "Regular Expression missing from global");
              return;
            }
            ...
            var v = 0,
              m = function () {
                if (v < c.length) {
                  ...
                  var r = n + 1 + a;
                  Yn.processCommand(e, r, { callback: m });
                }
              };
            m();
          },
          substitute: function (e, t) {
            ...
            if (r.length)
              (i = r[0]),
                rt("pcre") && i !== "" && (i = new RegExp(i).source),
                (s = r[1]),
                s !== undefined &&
                  (rt("pcre")
                    ? (s = _n(s.replace(/([^\\])&/g, "$1$$&")))
                    : (s = On(s)),
                  (at.lastSubstituteReplacePart = s)),
                (o = r[2] ? r[2].split(" ") : []);
            else if (n && n.length) {
              Hn(e, "Substitutions should be of the form :s/pattern/replace/");
              return;
            }
            o &&
              ((u = o[0]),
            ...
            if (i)
              try {
                ...
                Hn(e, "Invalid regex: " + i);
                return;
              }
            s = s || at.lastSubstituteReplacePart;
            if (s === undefined) {
              Hn(e, "No previous substitute regular expression");
              return;
            }
            var h = xn(e),
              p = h.getQuery(),
          ...
          delmarks: function (e, t) {
            ...
            while (!r.eol()) {
              ...
              var i = r.pos;
              if (!r.match(/[a-zA-Z]/, !1)) {
                Hn(e, "Invalid argument: " + t.argString.substring(i));
                return;
              }
              var s = r.next();
              if (r.match("-", !0)) {
        ...
        Yn = new Qn();
      (m.keyMap.vim = { attach: A, detach: L, call: O }),
        tt("insertModeEscKeysTimeout", 200, "number"),
        (m.keyMap["vim-insert"] = {
          fallthrough: ["default"],
          attach: A,
          detach: L,
      ...
      var dr = {
        ...
        mr = ct.handleKey.bind(ct);
      (ct.handleKey = function (e, t, n) {
        return e.operation(function () {
          return mr(e, t, n);
        }, !0);
      }),
        (t.CodeMirror = m);
      var br = ct.maybeInitVimState_;
      (t.handler = {
        $id: "ace/keyboard/vim",
        ...
        x.push({ keys: "gq", type: "operator", operator: "hardWrap" }),
        ct.defineOperator("hardWrap", function (e, t, n, r, i) {
          var s = n[0].anchor.line,
            o = n[0].head.line;
          return (
            t.linewise && o--, v(e.ace, { startRow: s, endRow: o }), w(o, 0)
          );
        }),
        ...
        (Tt.aceCommand = function (e, t, n) {
          (e.vimCmd = t),
            e.ace.inVirtualSelectionMode
              ? e.ace.on("beforeEndOperation", wr)
              : wr(null, e.ace);
        }),
        ...
        (t.handler.defaultKeymap = x),
        (t.handler.actions = Tt),
        (t.Vim = ct);
    }
  );
(function () {
