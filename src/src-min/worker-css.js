...
!(function (e) {
  ...
  define("ace/mode/css/csslint", [], function (e, t, n) {
    var r = (function () {
            ...
            })()(
              {
                  ...
                  function (e, t, n) {
                    ...
                    function s(e, t) {
                      (this.match = function (t) {
                        var n;
                        return (
                          t.mark(), (n = e(t)), n ? t.drop() : t.restore(), n
                        );
                      }),
                        (this.toString =
                          typeof t == "function"
                    ...
                    (s.prec = { MOD: 5, SEQ: 4, ANDAND: 3, OROR: 2, ALT: 1 }),
                      (s.parse = function (e) {
                        ...
                        (t = new r(e)),
                          ...
                          (o = function () {
                            var e = [u()];
                            while (t.readMatch(" | ") !== null) e.push(u());
                            return e.length === 1 ? e[0] : s.alt.apply(s, e);
                          }),
                          (u = function () {
                            var e = [a()];
                            while (t.readMatch(" || ") !== null) e.push(a());
                            return e.length === 1 ? e[0] : s.oror.apply(s, e);
                          }),
                          (a = function () {
                            var e = [f()];
                            while (t.readMatch(" && ") !== null) e.push(f());
                          ...
                          (l = function () {
                            ...
                            if (t.readMatch(/^\{\s*/) !== null) {
                              ...
                              var i = n(/^\d+/);
                              return (
                                n(/^\s*\}/), e.braces(Number(r), Number(i))
                              );
                            }
                            return e;
                          }),
                ...
                6: [
                  function (e, t, n) {
                    ...
                    (y.DEFAULT_TYPE = 0),
                      (y.COMBINATOR_TYPE = 1),
                      (y.MEDIA_FEATURE_TYPE = 2),
                      (y.MEDIA_QUERY_TYPE = 3),
                      (y.PROPERTY_NAME_TYPE = 4),
                      (y.PROPERTY_VALUE_TYPE = 5),
                      (y.PROPERTY_VALUE_PART_TYPE = 6),
                      (y.SELECTOR_TYPE = 7),
                      (y.SELECTOR_PART_TYPE = 8),
                      (y.SELECTOR_SUB_PART_TYPE = 9),
                        ...
                        var e = new r(),
                          ...
                          n = {
                            ...
                            _stylesheet: function () {
                                  ...
                                  switch (r) {
                                    ...
                                    case m.UNKNOWN_SYM:
                                      ...
                                      this.fire({
                                        ...
                                        (t = 0);
                                      while (
                                        e.advance([m.LBRACE, m.RBRACE]) ===
                                        m.LBRACE
                                      )
                                        t++;
                                      while (t) e.advance([m.RBRACE]), t--;
                                      break;
                                    case m.S:
                              ...
                              r !== m.EOF && this._unexpectedToken(e.token()),
                            ...
                            _charset: function (e) {
                              var t = this._tokenStream,
                                ...
                                i,
                                s;
                              t.match(m.CHARSET_SYM) &&
                                ((i = t.token().startLine),
                                (s = t.token().startCol),
                                this._readWhitespace(),
                                t.mustMatch(m.STRING),
                                (r = t.token()),
                                (n = r.value),
                                this._readWhitespace(),
                                t.mustMatch(m.SEMICOLON),
                                e !== !1 &&
                                  this.fire({
                                    type: "charset",
                                    charset: n,
                            ...
                            _import: function (e) {
                              var t = this._tokenStream,
                                ...
                                r,
                                i = [];
                              t.mustMatch(m.IMPORT_SYM),
                                (r = t.token()),
                                this._readWhitespace(),
                                t.mustMatch([m.STRING, m.URI]),
                                (n = t
                                  .token()
                                  .value.replace(
                                    /^(?:url\()?["']?([^"']+?)["']?\)?$/,
                            ...
                            _supports_declaration_condition: function (e) {
                              var t = this._tokenStream;
                              e !== !1 && t.mustMatch(m.LPAREN),
                                this._readWhitespace(),
                                this._declaration(),
                                t.mustMatch(m.RPAREN);
                            },
                            _media: function () {
                              var e = this._tokenStream,
                                t,
                                n,
                                r;
                              e.mustMatch(m.MEDIA_SYM),
                                (t = e.token().startLine),
                                (n = e.token().startCol),
                                this._readWhitespace(),
                                (r = this._media_query_list()),
                                e.mustMatch(m.LBRACE),
                                this._readWhitespace(),
                                this.fire({
                                  type: "startmedia",
                                  media: r,
                              ...
                              for (;;)
                                if (e.peek() === m.PAGE_SYM) this._page();
                            ...
                            _media_expression: function () {
                              ...
                              return (
                                ...
                                new u(
                                  t,
                                  r ? new s(r, n.startLine, n.startCol) : null
                                )
                              );
                            },
                            ...
                            _margin_sym: function () {
                              ...
                              return e.match([
                                ...
                                m.TOPCENTER_SYM,
                                m.TOPRIGHT_SYM,
                                m.TOPRIGHTCORNER_SYM,
                                m.BOTTOMLEFTCORNER_SYM,
                                m.BOTTOMLEFT_SYM,
                                m.BOTTOMCENTER_SYM,
                                m.BOTTOMRIGHT_SYM,
                                m.BOTTOMRIGHTCORNER_SYM,
                                m.LEFTTOP_SYM,
                                m.LEFTMIDDLE_SYM,
                                m.LEFTBOTTOM_SYM,
                                m.RIGHTTOP_SYM,
                            ...
                            _document: function () {
                              var e = this._tokenStream,
                                ...
                                n = [],
                                r = "";
                              e.mustMatch(m.DOCUMENT_SYM),
                                (t = e.token()),
                                /^@-([^-]+)-/.test(t.value) && (r = RegExp.$1),
                                this._readWhitespace(),
                            ...
                            _operator: function (e) {
                              var t = this._tokenStream,
                                n = null;
                              if (
                                t.match([m.SLASH, m.COMMA]) ||
                                (e && t.match([m.PLUS, m.STAR, m.MINUS]))
                              )
                            ...
                            _combinator: function () {
                              var e = this._tokenStream,
                                ...
                                n;
                              return (
                                e.match([m.PLUS, m.GREATER, m.TILDE]) &&
                                  ((n = e.token()),
                                  (t = new o(n.value, n.startLine, n.startCol)),
                                  this._readWhitespace()),
                                t
                              );
                            },
                            ...
                            _namespace_prefix: function () {
                              var e = this._tokenStream,
                                t = "";
                              if (e.LA(1) === m.PIPE || e.LA(2) === m.PIPE)
                                e.match([m.IDENT, m.STAR]) &&
                                  (t += e.token().value),
                                  e.mustMatch(m.PIPE),
                                  (t += "|");
                              return t.length ? t : null;
                              ...
                              return e.match(m.LBRACKET)
                                ? ((r = e.token()),
                                  ...
                                  e.match([
                                    ...
                                    ((t += e.token().value),
                                    (t += this._readWhitespace()),
                                    e.mustMatch([m.IDENT, m.STRING]),
                                    (t += e.token().value),
                                    (t += this._readWhitespace())),
                                  e.mustMatch(m.RBRACKET),
                                  new d(
                                    t + "]",
                                    "attribute",
                                    r.startLine,
                              ...
                              if (e.match(m.COLON)) {
                                e.match(m.COLON) && (n += ":"),
                                  e.match(m.IDENT)
                                    ? ((t = e.token().value),
                                      (r = e.token().startLine),
                                      (s = e.token().startCol - n.length))
                                    : e.peek() === m.FUNCTION &&
                                      ((r = e.LT(1).startLine),
                                      (s = e.LT(1).startCol - n.length),
                            ...
                            _negation_arg: function () {
                              ...
                              return (
                                ...
                                n.type === "elementName"
                                  ? (u = new p(n, [], n.toString(), s, o))
                                  : (u = new p(null, [n], n.toString(), s, o)),
                                u
                              );
                            },
                            ...
                            _key: function () {
                              var e = this._tokenStream,
                                t;
                              if (e.match(m.PERCENTAGE))
                                return s.fromToken(e.token());
                              if (e.match(m.IDENT)) {
                                t = e.token();
                            ...
                            _skipCruft: function () {
                              while (
                                this._tokenStream.match([m.S, m.CDO, m.CDC])
                              );
                            },
                            _readDeclarations: function (e, t) {
                              ...
                              try {
                                ...
                                else if (r !== m.EOF && r !== m.RBRACE) throw s;
                              }
                            },
                            _readWhitespace: function () {
                              var e = this._tokenStream,
                                t = "";
                              while (e.match(m.S)) t += e.token().value;
                              return t;
                            },
                ...
                8: [
                  function (e, t, n) {
                    "use strict";
                    function s(e, t, n, s) {
                      r.call(this, e, n, s, i.PROPERTY_NAME_TYPE),
                        (this.hack = t);
                    }
                    t.exports = s;
                    var r = e("../util/SyntaxUnit"),
                ...
                9: [
                  function (e, t, n) {
                    "use strict";
                    function s(e, t, n) {
                      r.call(this, e.join(" "), t, n, i.PROPERTY_VALUE_TYPE),
                        (this.parts = e);
                    }
                    t.exports = s;
                    var r = e("../util/SyntaxUnit"),
                ...
                11: [
                  function (e, t, n) {
                    ...
                    function u(e, t, n, o) {
                      var a = o || {};
                      r.call(this, e, t, n, s.PROPERTY_VALUE_PART_TYPE),
                        (this.type = "unknown");
                      var f;
                      if (/^([+-]?[\d.]+)([a-z]+)$/i.test(e)) {
                        (this.type = "dimension"),
                  ...
                  function (e, t, n) {
                    ...
                    function o(e, t, n) {
                      r.call(this, e.join(" "), t, n, i.SELECTOR_TYPE),
                        (this.parts = e),
                        (this.specificity = s.calculate(this));
                    }
                    t.exports = o;
                    var r = e("../util/SyntaxUnit"),
                      i = e("./Parser"),
                ...
                14: [
                  function (e, t, n) {
                    "use strict";
                    function s(e, t, n, s, o) {
                      r.call(this, n, s, o, i.SELECTOR_PART_TYPE),
                        (this.elementName = e),
                        (this.modifiers = t);
                    }
                    t.exports = s;
                ...
                15: [
                  function (e, t, n) {
                    "use strict";
                    function s(e, t, n, s) {
                      r.call(this, e, n, s, i.SELECTOR_SUB_PART_TYPE),
                        (this.type = t),
                        (this.args = []);
                    }
                    t.exports = s;
                ...
                16: [
                  function (e, t, n) {
                    ...
                    (s.prototype = {
                      ...
                      valueOf: function () {
                        return (
                          this.a * 1e3 + this.b * 100 + this.c * 10 + this.d
                        );
                      },
                      toString: function () {
                        return (
                    ...
                    w.prototype = g(new r(), {
                      _getToken: function () {
                        ...
                        while (e) {
                          switch (e) {
                            case "/":
                              t.peek() === "*"
                                ? (n = this.commentToken(e, r, i))
                                : (n = this.charToken(e, r, i));
                              break;
                            case "|":
                            case "~":
                            case "^":
                            ...
                            case "-":
                              ...
                              t.peekCount(2) === "->"
                                ? (n = this.htmlCommentEndToken(e, r, i))
                        ...
                        return (
                          !n &&
                            e === null &&
                            (n = this.createToken(s.EOF, null, r, i)),
                          n
                        );
                      },
                      _getDefaultToken: function (e, t, n) {
                        var r = this._reader,
                          i = null;
                        return (
                          c(e)
                      ...
                      atRuleToken: function (e, t, n) {
                        ...
                        i.mark(),
                          (u = this.readName()),
                          (r = e + u),
                          (o = s.type(r.toLowerCase()));
                        if (o === s.CHAR || o === s.UNKNOWN)
                          r.length > 1
                            ? (o = s.UNKNOWN_SYM)
                            : ((o = s.CHAR), (r = e), i.reset());
                      ...
                      charToken: function (e, t, n) {
                        var r = s.type(e),
                          i = {};
                        return (
                          r === -1 ? (r = s.CHAR) : (i.endChar = s[r].endChar),
                      ...
                      identOrFunctionToken: function (e, t, n) {
                        ...
                        return (
                          r.peek() === "("
                            ? ((i += r.read()),
                              u.indexOf(i.toLowerCase()) > -1
                                ? (r.mark(),
                                  (a = this.readURI(i)),
                                  a === null
                                    ? (r.reset(), (o = s.FUNCTION))
                                    : ((o = s.URI), (i = a)))
                                : (o = s.FUNCTION))
                            : r.peek() === ":" &&
                              i.toLowerCase() === "progid" &&
                              ((i += r.readTo("(")), (o = s.IE_FUNCTION)),
                            ...
                            i.length === 2
                              ...
                              : ((u = s.UNICODE_RANGE),
                                i.indexOf("?") === -1 &&
                                  ...
                                  (r.mark(),
                                  (o = r.read()),
                                  (o += this.readUnicodeRangePart(!1)),
                                  o.length === 1 ? r.reset() : (i += o)))),
                          this.createToken(u, i, t, n)
                        );
                      },
                      ...
                      readURI: function (e) {
                        var t = this._reader,
                          ...
                          r = "",
                          s = t.peek();
                        while (s && h(s)) t.read(), (s = t.peek());
                        s === "'" || s === '"'
                          ? ((r = this.readString()),
                            r !== null && (r = i.parseString(r)))
                ...
                21: [
                  function (e, t, n) {
                    ...
                    s(r, {
                      ...
                      describe: function (e) {
                        return this.complex[e] instanceof i
                      ...
                      simple: {
                        ...
                        "<feature-tag-value>": function (e) {
                          return (
                            e.type === "function" && /^[A-Z0-9]{4}$/i.test(e)
                          );
                        },
                        "<filter-function>":
                        ...
                        "<opacity-value>": function (e) {
                          return (
                            this["<number>"](e) && e.value >= 0 && e.value <= 1
                          );
                        },
                      ...
                      complex: {
                        ...
                        "<dasharray>": i
                          ...
                          .braces(1, Infinity, "#", i.cast(",").question()),
                        "<family-name>":
                    ...
                    (t.exports = r),
                      (r.prototype = {
                        ...
                        peekCount: function (e) {
                          return (
                            (e = typeof e == "undefined" ? 1 : Math.max(e, 0)),
                        ...
                        get: function (e) {
                          ...
                          if (
                            ...
                            n++,
                              ...
                              (i = t[this._token.type]);
                            while (
                              typeof i.channel != "undefined" &&
                              e !== i.channel &&
                              this._ltIndex < this._lt.length
                            )
                              (this._token = this._lt[this._ltIndex++]),
                            ...
                            if (
                              ...
                              return (
                                this._ltIndexCache.push(n), this._token.type
                              );
                          }
                          return (
                            (r = this._getToken()),
                            r.type > -1 &&
                              !t[r.type].hide &&
                              ((r.channel = t[r.type].channel),
                              (this._token = r),
                              this._lt.push(r),
                              this._ltIndexCache.push(
                                this._lt.length - this._ltIndex + n
                              ),
        ...
        r = (function () {
          ...
          function s(n, o, u, a, f) {
            function d(n, u) {
              ...
              else if (s.__isArray(n)) v = [];
              else if (s.__isRegExp(n))
                (v = new RegExp(n.source, l(n))),
                  n.lastIndex && (v.lastIndex = n.lastIndex);
              else if (s.__isDate(n)) v = new Date(n.getTime());
              else {
                if (p && Buffer.isBuffer(n))
                  return (
                    Buffer.allocUnsafe
                      ? (v = Buffer.allocUnsafe(n.length))
                      : (v = new Buffer(n.length)),
                    n.copy(v),
                    v
                  );
                e(n, Error)
          ...
          function u(e) {
            return typeof e == "object" && o(e) === "[object Date]";
          }
          function a(e) {
            return typeof e == "object" && o(e) === "[object Array]";
          }
          function f(e) {
            return typeof e == "object" && o(e) === "[object RegExp]";
          }
          function l(e) {
            var t = "";
            return (
      ...
      typeof e == "object" && e.exports && (e.exports = r);
      var i = (function () {
        "use strict";
        function a(e, t) {
          var n,
            ...
            i.Util.forEach(h, function (e, t) {
              g === null &&
                ...
                e.match(/\/\*[ \t]*csslint[ \t]+ignore:end[ \t]*\*\//i) &&
                  (y = t),
                g !== null && y !== null && (d.push([g, y]), (g = y = null));
            }),
              g !== null && d.push([g, h.length]),
              f || (f = u.getRuleset()),
              o.test(t) && ((f = r(f)), (f = a(t, f))),
              (c = new s(h, f, p, d)),
              (f.errors = 2);
            for (l in f) f.hasOwnProperty(l) && f[l] && e[l] && e[l].init(m, c);
            try {
              m.parse(t);
            } catch (b) {
              c.error(
                "Fatal error, cannot continue: " + b.message,
                b.line,
                b.col,
                {}
              );
        ...
        (s.prototype = {
          ...
          report: function (e, t, n, r) {
            ...
            if (
              ...
              this.allow[t].hasOwnProperty(r.id)
            )
              return;
          ...
          isIgnored: function (e) {
            ...
            var t = !1;
            return (
              i.Util.forEach(this.ignore, function (n) {
                n[0] <= e && e <= n[1] && (t = !0);
              }),
              t
            );
                  ...
                  for (f in r)
                    r.hasOwnProperty(f) &&
                      ...
                      i.Util.indexOf(l, a.text) > -1 &&
                        ...
                        i.Util.indexOf(e[f].actual, a.text) === -1 &&
                          (e[f].actual.push(a.text),
                          e[f].actualNodes.push(a))));
                }
                for (f in e)
                ...
                if (u.type === e.SELECTOR_PART_TYPE) {
                  ...
                  if (!s)
                    for (l = 0; l < u.modifiers.length; l++)
                      (a = u.modifiers[l]),
                        a.type === "attribute" &&
                          (!u.elementName || u.elementName === "*") &&
                          t.report(n.desc, u.line, u.col, n);
                }
              }
            });
          },
        ...
        i.addFormatter({
          ...
          endFormat: function () {
            ...
            return (
              this.json.length > 0 &&
                (this.json.length === 1
                  ? (e = JSON.stringify(this.json[0]))
                  : (e = JSON.stringify(this.json))),
              e
            );
          },
          formatResults: function (e, t, n) {
              ...
              n.length > 0 &&
                ...
                i.Util.forEach(n, function (e) {
                  if (e.rollup)
                    ...
                    var t = "";
                    e.rule && e.rule.id && (t = 'rule="' + s(e.rule.id) + '" '),
                      r.push(
                        "<issue " +
                          t +
                          'line="' +
        ...
        i.addFormatter({
          ...
          formatResults: function (e, t, n) {
            ...
            (s = "\n\ncsslint: There "),
              r.length === 1
                ? (s += "is 1 problem")
                : (s += "are " + r.length + " problems"),
              (s += " in " + t + ".");
            var o = t.lastIndexOf("/"),
              u = t;
            return (
              o === -1 && (o = t.lastIndexOf("\\")),
              o > -1 && (u = t.substring(o + 1)),
              i.Util.forEach(r, function (e, t) {
                (s = s + "\n\n" + u),
                  e.rollup
                    ? ((s += "\n" + (t + 1) + ": " + e.type),
                      (s += "\n" + e.message))
